...
export const questions: Question[] = [
    ...
    },
    {
        ...
        workedSolution: { steps: [
            ...
            { stepNumber: 3, description: 'Calculate the x-coordinate of P.', workingLatex: 'x_P = \\frac{1(7) + 2(1)}{1 + 2} = \\frac{7 + 2}{3} = \\frac{9}{3} = 3', explanation: 'Multiply \\( x_2 \\) by \\( m \\) and \\( x_1 \\) by \\( n \\), then divide by \\( m + n \\).' },
            { stepNumber: 4, description: 'Calculate the y-coordinate of P.', workingLatex: 'y_P = \\frac{1(8) + 2(2)}{1 + 2} = \\frac{8 + 4}{3} = \\frac{12}{3} = 4', explanation: 'Multiply \\( y_2 \\) by \\( m \\) and \\( y_1 \\) by \\( n \\), then divide by \\( m + n \\).' },
    ...
    },
    {
        ...
        workedSolution: { steps: [
            ...
            { stepNumber: 4, description: 'Simplify the square root.', workingLatex: 'd = 13', explanation: '\\( 169 = 13 \\times 13 \\), so \\( \\sqrt{169} = 13 \\). This is a 5-12-13 Pythagorean triple.' }
        ], finalAnswer: '\\(13\\)' }
    },
    {
    ...
    },
    {
        ...
        workedSolution: { steps: [
            { stepNumber: 1, description: '(a) Side lengths', workingLatex: 'PQ = 6, \\quad PR = \\sqrt{9+36} = \\sqrt{45} = 3\\sqrt{5}, \\quad QR = \\sqrt{9+36} = 3\\sqrt{5}', explanation: '\\( PQ \\) is horizontal (same y-coordinate), so its length is simply \\( |8 - 2| = 6 \\). Simplify surds: \\( \\sqrt{45} = \\sqrt{9 \\times 5} = 3\\sqrt{5} \\).' },
            { stepNumber: 2, description: 'Perimeter', workingLatex: 'P = 6 + 6\\sqrt{5} \\approx 19.42', explanation: 'Sum all three sides: \\( 6 + 3\\sqrt{5} + 3\\sqrt{5} = 6 + 6\\sqrt{5} \\). Collect like surds before adding.' },
