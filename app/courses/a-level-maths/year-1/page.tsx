  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      ...
      <div className="fade-up-delay-1 flex items-baseline gap-3 mb-2">
        <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-accent">Year 12</span>
      ...
      <div className="fade-up-delay-2 mt-8 grid gap-5 sm:grid-cols-3 mb-10">
        {[
          { title: "Pure Mathematics", icon: "\u222B", desc: "Algebra, trigonometry, calculus, vectors and more.", href: "/student/questions?year=1&component=pure" },
          { title: "Statistics", icon: "\u03A3", desc: "Sampling, probability, distributions, hypothesis testing.", href: "/student/questions?year=1&component=statistics" },
          { title: "Mechanics", icon: "\u2192", desc: "Forces, motion, energy and momentum.", href: "/student/questions?year=1&component=mechanics" },
        ].map((c) => (
          <Link
            key={c.title}
            href={c.href}
